...
A single responsive web page rendered from mockups for desktop and mobile provided, written using HTML5, CSS3 (SCSS) and JavaScript and built using Vite. 

</div>

<strong>:heavy_check_mark: Features</strong>
 - UI faithful to mockups
...
<strong>:link: Links</strong><br>
 - <a target="_blank" href="https://vertu-motors-interview-web-page.vercel.app/">Vertu Motors - Interview Page</a>